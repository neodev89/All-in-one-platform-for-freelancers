...
import { DBFreelanceTypeInsert, freelanceData } from "@/db/schema/freelance-data";
...
export async function POST() {
    ...
    try {
        ...
        const parsedFile = readFile !== "" ? JSON.parse(readFile) as Array<DBFreelanceTypeInsert> : null;
        ...
        // Qui fallisce!!!
        await db.insert(freelanceData).values(validDateParsedFile);

        const response: ApiResponse<Array<DBFreelanceTypeInsert>> = {
            success: true,
